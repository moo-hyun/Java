...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		boolean rs6 = var1 != var2; //var1은 var1보다 서로 다르다
		...
		boolean res1 = (var3 > 3) && (var4 > 3); // f
		boolean res2 = (var3 > 2) && (var4 > 3); // t
		boolean res3 = (var3 > 3) || (var4 > 3); // t
		boolean res4 = (var3 > 3) || (var4 > 5); // f
		boolean res5 = !(var3 > var4); // t
